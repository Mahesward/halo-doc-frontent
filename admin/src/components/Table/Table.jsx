...
const Table = () => {
    ...
    const deleteHandler = async (id) => {
        const result = await backend_api.delete(`/doctors/delete-doctor/${id}`)
        ...
        <>
            <section className="container px-4 mx-auto py-6 w-11/12">
                <div className="flex items-center justify-between">
                    ...
                    <div>
                        <Link to='add-doctors' className="rounded-md bg-indigo-600 px-3.5 py-1.5 text-sm font-semibold leading-7 text-white hover:bg-indigo-500 ">
                            Add
                        </Link>
                    </div>
                </div>
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    ...
                                                    >
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={(e) => { deleteHandler(doctor._id) }}
                                                        >
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                fill="none"
